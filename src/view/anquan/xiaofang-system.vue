      ...
      <el-row :gutter="10" class="jiankong-block height-100 animate__animated animate__fadeInDown">
        ...
        <el-col :span="6" class="height-100">
          <div class="bg-rt">
            ...
            <div id="xiaofang-by-area-chart" ></div>
          </div>
        </el-col>
      </el-row>
    </div>
...
export default {
  ...
  mounted(){
    this.initChart({
      color: ['#00e9ff', '#394042'],
      element: 'xiaofang-by-area-chart',
      data: [{ value: 145 }, { value: 75 }]
    })
    window.onresize = function(){
      echarts.getInstanceByDom($('#xiaofang-by-area-chart')[0]).resize()
    }
  },
  methods: {
    getDetail() {
