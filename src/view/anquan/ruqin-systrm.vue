          ...
          <div class="bg-rt">
            <div class="title-common-box">
              <div class="text-common-1-level">
                <div class="text-left">按区域入侵次数</div>
                <div class="text-shu">|</div>
                <div class="text-liner-bg"></div>
              </div>
            </div>
            <div id="ruqin-by-area-chart" ></div>
          </div>
        </el-col>
      </el-row>
    </div>
...
export default {
  ...
  mounted(){
    this.initChart({
      color: ['#00e9ff', '#394042'],
      element: 'ruqin-by-area-chart',
      data: [{ value: 145 }, { value: 75 }]
    })
    window.onresize = function(){
      echarts.getInstanceByDom($('#ruqin-by-area-chart')[0]).resize()
    }
  },
  methods: {
    getDetail() {
